...
class InterviewPreprocessingKeywordRepositoryImpl(InterviewPreprocessingKeywordRepository):
    ...
    QUESTIONS = ['<k> 관련 경험이 있으신가요?', '<k> 관련 경험이 있으십니까', '<k> 관련 경험이 있다면 말씀 부탁드립니다.',
                 ...
                 '귀하께서는 <k>에 능숙한 편이신가요?', '<k>을 어느정도까지 활용할 수 있으신가요?', '<k>을 능숙하게 사용하실 수 있나요?',
                 '<k>에 자신이 있으십니까?', '왜 <k>을 사용하시는 지 알고 계신가요?', '<k>의 장점에 대해 설명해 보세요.',
                 ...
                 '<k>이란 무엇인지에 대해서 설명 부탁드립니다.', '지원자님은 <k>이 왜 필요하다고 생각하십니까?',
                 '<k>가 왜 필요하다고 생각하시나요?']
