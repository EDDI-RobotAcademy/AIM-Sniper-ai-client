...
class InterviewPreprocessingKeywordRepositoryImpl(InterviewPreprocessingKeywordRepository):
    ...
    QUESTIONS = ['<k> 관련 경험이 있으신가요?', '<k> 관련 경험이 있으십니까', '<k> 관련 경험이 있다면 말씀 부탁드립니다.',
                 ...
                 '귀하께서는 <k>을 이해하고 활용하는 데 능숙한 편이신가요?', '<k>을 어느정도까지 활용할 수 있으신가요?', '<k>을 능숙하게 사용하실 수 있나요?',
                 '<k> 활용에 자신이 있으십니까?', '왜 <k>을 사용하시는 지 알고 계신가요?', '<k>의 장점에 대해 설명해 보세요.',
                 '<k>에 대해서 본인이 아시는 대로 설명해 주십시오', '<k>이란 무엇이고 대표적인 장점과 단점은 무엇이 있을까요?',
                 '<k>에 관해서 구체적으로 이야기 해 보시기 바랍니다', '<k>에 대해 알고 계시다면 자유롭게 설명해 주시길 바랍니다.',
                 '<k>이란 무엇인지 아시는 대로 설명해주시길 바랍니다.', '<k>에 대해서 지원자님께서 아시는 대로 한번 편하게 설명해 주시겠습니까',
                 '지원자님께서 생각하는 <k>이란 무엇인지, 그리고 <k>의 장점은 무엇인지 말씀 부탁드립니다.',
                 '<k>의 장점과 단점에 대해 아시는 대로 편하게 설명 부탁드립니다.', '<k>이 무엇인지 설명해주실 수 있을까요?',
                 '<k>이란 무엇인지에 대해서 설명 부탁드립니다.', '지원자님은 <k>이 해당 분야에서 왜 필요하다고 생각하십니까?',
                 '해당 분야에서 <k>이 왜 필요하다고 생각하시나요?']
