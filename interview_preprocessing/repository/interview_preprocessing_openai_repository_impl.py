            ...
            messages=[
                ...
                {"role": "user",
                 "content":
                     ...
                     feedback:답변에서 페어 프로그래밍의 장점에 대한 설명이 있지만, 내용이 다소 중복되고 모호하게 표현되어 있습니다. 페어 프로그래밍이 어떻게 개발 과정에서 효과적으로 작용하는지에 대한 구체적인 예시나 개인의 역량에 대한 서술이 부족합니다. 좀 더 명확하고 구체적인 내용을 제시하는 것이 좋겠습니다.
                     5. output은 "answer:~<s>feedback:~" 형식으로만 출력해줘.
                     """
