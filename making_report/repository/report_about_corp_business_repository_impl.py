...
class ReportAboutCorpBusinessRepositoryImpl(ReportAboutCorpBusinessRepository):
    __instance = None
    WANTED_CORP_LIST = [
        'SK네트웍스', 'SK이노베이션', 'SK텔레콤', 'SK하이닉스',
        '삼성전자', 'LG에너지솔루션', 'NAVER', '삼성바이오로직스', '카카오뱅크',
        '삼성SDI', 'LG화학', '기아', 'POSCO홀딩스', '대한항공',
        '삼성물산', '현대모비스', 'LG전자', '한국전력공사', '셀트리온',
        'LG생활건강', 'HMM', '삼성생명', '하이브',
        '삼성전기', 'SK바이오사이언스', 'LG', 'S-Oil', '고려아연', '케이티앤지', '우리금융지주',
        '삼성에스디에스', '엔씨소프트', '삼성화재해상보험', '아모레퍼시픽',
        '포스코퓨처엠', '미래에셋증권']
